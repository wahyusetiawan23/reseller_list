...
<head>
	...
	<link rel="stylesheet" crossorigin href="<?= $base?>assets/compiled/css/app.css">
	<link rel="stylesheet" crossorigin href="<?= $base?>assets/compiled/css/app-dark.css">

	<script src="https://code.jquery.com/jquery-3.7.0.js"
			integrity="sha256-JlqSTELeR4TLqP0OG9dxM7yDPqX1ox/HfgiSLBj8+kM=" crossorigin="anonymous"></script>

	<link rel="stylesheet" href="<?= $base?>assets/extensions/datatables.net-bs5/css/dataTables.bootstrap5.min.css">
	<link rel="stylesheet" crossorigin href="<?= $base?>assets/compiled/css/table-datatable-jquery.css">

	<link rel="stylesheet" href="<?= $base?>assets/extensions/choices.js/public/assets/styles/choices.css">

	<link rel="stylesheet" href="<?= $base?>assets/extensions/sweetalert2/sweetalert2.min.css">
	<link rel="stylesheet" crossorigin href="<?= $base?>assets/compiled/css/extra-component-sweetalert.css">
</head>
		...
		<div class="sidebar-wrapper active">
			...
			<div class="sidebar-menu">
				<ul class="menu">
					...
					<li class="sidebar-item" id="resellerNAV">
		...
		<footer>
			<div class="footer clearfix mb-0 text-muted">
				<div class="float-start">
					<p><?= date('Y') ?> &copy; BorneoTeam</p>
				</div>
				<div class="float-end">
					<p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
						by <a href="https://borneoschematic.com/" target="_blank">BorneoTeam</a></p>
				</div>
			</div>
		</footer>
	</div>
...
<script src="<?= $base ?>assets/static/js/components/dark.js"></script>
<script src="<?= $base ?>assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js"></script>


<script src="<?= $base ?>assets/compiled/js/app.js"></script>

<script src="<?= $base ?>assets/extensions/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<?= $base ?>assets/extensions/datatables.net-bs5/js/dataTables.bootstrap5.min.js"></script>
<script src="<?= $base ?>assets/static/js/pages/datatables.js"></script>
<script src="<?= $base ?>assets/extensions/sweetalert2/sweetalert2.min.js"></script>>
<script src="<?= $base ?>assets/static/js/pages/sweetalert2.js"></script>>
